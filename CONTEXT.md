...
- **Publication** — an explicitly approved GitLab branch, commit, and merge request produced from a tested code Candidate. A Publication is never an automatic merge.
